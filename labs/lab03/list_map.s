...
main:
    ...
    add s0, a0, x0      # s0 = a0; head of node list
...
loop:                   # do...
    ...
    jr ra
malloc:
    addi a1, a0, 0      # a1 = 8; n bytes to allocate
    addi a0, x0, 9      # a0 = 9; syscall number: "allocates a1 bytes on the heap, returns pointer to start in a0"
    ecall
    jr  ra
